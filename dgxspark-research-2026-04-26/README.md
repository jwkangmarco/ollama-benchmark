...
5. **실측 latency 프로파일** — `qwen3.6:35b`가 `qwen3.6:27b` 대비 **TTFT 1.5배, TPOT 5배, throughput 5배 우수** (57.3 vs 11.6 tok/s) — 대역폭 제약 + MoE의 효과를 실증.
...
| [`latency-results.md`](latency-results.md) | TTFT / TPOT / Throughput 실측 결과 |
